package com.ubisys.drone.generator;

import cn.hutool.core.util.StrUtil;
import com.ubisys.drone.generator.bean.EntityOfEntity;
...
public class DroneGenerator {
     ...
     * 实体类名
     */
    private static final String className = "DictData";

    /**
     * 类说明描述
     */
    private static final String description = "O(∩_∩)O哈哈~";

    /**
     * 作者名
     */
    private static final String author = "miaomiao";
     ...
     * 主键类型
     */
    private static final String primaryKeyType = "Integer";

    /**
     * 实体类对应包
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.ubisys.drone.modules.base.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.ubisys.drone.modules.base.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.ubisys.drone.modules.base.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.ubisys.drone.modules.base.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.ubisys.drone.modules.base.controller";


    public static void main(String[] args) throws IOException {

        //模板路径
        String root = System.getProperty("user.dir") + "/src/main/java/com/ubisys/drone/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException {
        ...
        log.info("serviceImplResult ", serviceImplResult);
        //创建文件
