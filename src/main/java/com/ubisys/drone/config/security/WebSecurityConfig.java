...
import com.ubisys.drone.config.IgnoredUrlsProperties;
import com.ubisys.drone.config.security.jwt.*;
import com.ubisys.drone.config.security.permission.MyFilterSecurityInterceptor;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Value("${drone.token.redis}")
    private Boolean tokenRedis;

    @Value("${drone.tokenExpireTime}")
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        registry.and()
                //表单登录方式
                .formLogin()
                .loginPage("/drone/common/needLogin")
                //登录请求url
                .loginProcessingUrl("/drone/login")
                .permitAll()
                //成功处理类
