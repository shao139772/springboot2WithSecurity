...
@Data
@Entity
@Table(name = "ub_pending_certification")
@TableName("ub_pending_certification")
public class UbisysPendingCertification extends DroneBaseEntity {
    ...
    public String toString() {
        return "UbisysPendingCertification{" +
