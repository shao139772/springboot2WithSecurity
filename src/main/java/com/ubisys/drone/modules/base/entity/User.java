...
@Table(name = "sys_user")
@TableName("sys_user")
public class User extends DroneBaseEntity {
    ...
    @Column(length = 1000)
    private String avatar = DroneConstant.USER_DEFAULT_AVATAR;

    @ApiModelProperty(value = "用户类型 0普通用户 1管理员")
    private Integer type = DroneConstant.USER_TYPE_NORMAL;

    @ApiModelProperty(value = "状态 默认0正常 -1拉黑")
    private Integer status = DroneConstant.USER_STATUS_NORMAL;
